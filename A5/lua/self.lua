...
red = gr.material({1, 0.6, 0.6}, {0.5, 0.4, 0.8}, 25,0)
white = gr.material({1, 1, 1}, {0.5, 0.4, 0.8}, 25,0)
brown = gr.material({101.0/255, 69.0/255, 34.0/255}, {0.8, 0.8, 0.2}, 2,0)
...
gr.render(root, '../img/self_bb3.png', 512, 512,
