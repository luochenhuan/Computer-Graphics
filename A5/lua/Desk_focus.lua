...
-- scene_root:add_child(upperlamp)

-- upperlamp:translate(120,400,200)

-- string = gr.nh_cylinder('string', {0, 0, 0}, {0, 1, 0}, 10, 100)
...
---------------------------  lamp -------------------------------------
-- conelamp = gr.nh_cone('conelamp', {0,0,0}, 300, 400, 200)
-- upperlamp:add_child(conelamp)
-- conelamp:translate(0, 0, 0)
-- conelamp:rotate('X',90)
...
gr.render(scene_root, '../img/deskfocus_obj.png', 2048, 2048,
