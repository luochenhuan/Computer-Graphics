...
mat1 = gr.material({0.7, 1.0, 0.7}, {0.5, 0.7, 0.5}, 25,0.5)
...
glass = gr.material({0.3, 0.3, 0.7}, {0.5, 0.7, 0.5}, 25, 0, 1.3)

scene_root = gr.node('root')

s0 = gr.nh_sphere('s0', {0, 0, -400}, 100)
scene_root:add_child(s0)
s0:set_material(mat1)
...
s1 = gr.nh_sphere('s1', {-20, 10, 350}, 100)
...
gr.render(scene_root, 'refract_test.png', 256, 256,
